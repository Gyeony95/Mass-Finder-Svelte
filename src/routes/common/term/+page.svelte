<div id="sub_title" class="module">
	<h1>이용약관<span class="sub_title_desc" /></h1>
</div>
		...
		<ul class="terms_lst">
			<li>
				<dl>
					<dt>제1조(목적)</dt>
					<dd>
						이 약관은 삼원파워감속기 회사(전자상거래 사업자)가 운영하는 삼원파워감속기 사이버
						몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에
											...
											<li>
												<dl>
													...
													<dd>
														...
														개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 삼원파워감속기
																						...
																						<dl>
																							...
																							<li>
																								<dl>
																									<dt>제6조(회원가입)</dt>
																									<dd>
																										① 이용자는 “몰”이 정한 가입 양식에 따라
																										회원정보를 기입한 후 이 약관에 동의한다는
																										의사표시를 함으로서 회원가입을 신청합니다.
																									</dd>
																									<dd>
																										② “몰”은 제1항과 같이 회원으로 가입할 것을
																										신청한 이용자 중 다음 각 호에 해당하지 않는 한
																										회원으로 등록합니다.
																									</dd>
																									<dd>
																										...
																										<dl>
																											...
																											<li>
																												<dl>
																													...
																													<dd>
																														① 회원은 “몰”에 언제든지 탈퇴를 요청할
																														수 있으며 “몰”은 즉시 회원탈퇴를
																														처리합니다.
																													</dd>
																													<dd>
																														② 회원이 다음 각 호의 사유에 해당하는
																														경우, “몰”은 회원자격을 제한 및 정지시킬
																														수 있습니다.
																													</dd>
																													<dd>
																													...
																													<dd>
																														...
																														대금, 기타 “몰”이용에 관련하여 회원이
																														부담하는 채무를 기일에 지급하지 않는
																														경우
																													</dd>
																													<dd>
																														3. 다른 사람의 “몰” 이용을 방해하거나 그
																														정보를 도용하는 등 전자상거래 질서를
																														위협하는 경우
																													</dd>
																													<dd>
																													...
																													<dd>
																														③ “몰”이 회원 자격을 제한•정지 시킨 후,
																														동일한 행위가 2회 이상 반복되거나 30일
																													...
																													<dd>
																														...
																														이를 통지하고, 회원등록 말소 전에 최소한
																														30일 이상의 기간을 정하여 소명할 기회를
																														부여합니다.
																													</dd>
																													<li>
																														<dl>
